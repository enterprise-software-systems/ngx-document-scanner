...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(LimitsService, [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
/** @nocollapse */ NgxDraggablePointComponent.ɵfac = function NgxDraggablePointComponent_Factory(t) { return new (t || NgxDraggablePointComponent)(i0.ɵɵdirectiveInject(LimitsService)); };
/** @nocollapse */ NgxDraggablePointComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: NgxDraggablePointComponent, selectors: [["ngx-draggable-point"]], hostBindings: function NgxDraggablePointComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
    ...
    }, dependencies: [i2.DefaultStyleDirective, i3.AngularDraggableDirective, i5.NgStyle] });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxDraggablePointComponent, [{
            type: Component,
...
/** @nocollapse */ NgxFilterMenuComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: NgxFilterMenuComponent, selectors: [["ngx-filter-menu"]], outputs: { filterSelected: "filterSelected" }, decls: 2, vars: 1, consts: [["mat-list-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["mat-list-item", "", 3, "click"], ["fxFlex", "100", 2, "text-align", "start", "margin", "5px"], ["fxFlex", "100"], [4, "ngIf"]], template: function NgxFilterMenuComponent_Template(rf, ctx) {
    ...
    }, dependencies: [i5$1.DefaultFlexDirective, i3$1.MatIcon, i4.MatActionList, i4.MatListItem, i5.NgForOf, i5.NgIf], encapsulation: 2 });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxFilterMenuComponent, [{
            type: Component,
        ...
        return [{ type: i1.MatBottomSheetRef }, { type: undefined, decorators: [{
                        type: Inject,
...
/** @nocollapse */ NgxShapeOutlineComponent.ɵfac = function NgxShapeOutlineComponent_Factory(t) { return new (t || NgxShapeOutlineComponent)(i0.ɵɵdirectiveInject(LimitsService)); };
/** @nocollapse */ NgxShapeOutlineComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: NgxShapeOutlineComponent, selectors: [["ngx-shape-outine"]], viewQuery: function NgxShapeOutlineComponent_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, dependencies: [i2.DefaultStyleDirective, i5.NgIf, i5.NgStyle], encapsulation: 2 });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxShapeOutlineComponent, [{
            type: Component,
...
/** @nocollapse */ NgxDocScannerComponent.ɵfac = function NgxDocScannerComponent_Factory(t) { return new (t || NgxDocScannerComponent)(i0.ɵɵdirectiveInject(i1$1.NgxOpenCVService), i0.ɵɵdirectiveInject(LimitsService), i0.ɵɵdirectiveInject(i1.MatBottomSheet), i0.ɵɵdirectiveInject(i4$1.DomSanitizer)); };
/** @nocollapse */ NgxDocScannerComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: NgxDocScannerComponent, selectors: [["ngx-doc-scanner"]], viewQuery: function NgxDocScannerComponent_Query(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxDocScannerComponent, [{
        ...
        }], function () { return [{ type: i1$1.NgxOpenCVService }, { type: LimitsService }, { type: i1.MatBottomSheet }, { type: i4$1.DomSanitizer }]; }, { previewCanvas: [{
                type: ViewChild,
...
/** @nocollapse */ NgxDocumentScannerModule.ɵinj = /** @pureOrBreakMyCode */ i0.ɵɵdefineInjector({ providers: [
        ...
        AngularDraggableModule] });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxDocumentScannerModule, [{
            type: NgModule,
            args: [{
                    declarations: [
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(NgxDocumentScannerModule, { declarations: [NgxDraggablePointComponent,
            NgxFilterMenuComponent,
            NgxShapeOutlineComponent,
