...
class NgxDraggablePointComponent {
    ...
    /** @nocollapse */ static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: NgxDraggablePointComponent, deps: [{ token: LimitsService }], target: i0.ɵɵFactoryTarget.Component }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: NgxDraggablePointComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: LimitsService }], propDecorators: { width: [{
                type: Input
            }], height: [{
                type: Input
            }], color: [{
...
class NgxShapeOutlineComponent {
    ...
    /** @nocollapse */ static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: NgxShapeOutlineComponent, deps: [{ token: LimitsService }], target: i0.ɵɵFactoryTarget.Component }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: NgxShapeOutlineComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: LimitsService }], propDecorators: { color: [{
                type: Input
            }], weight: [{
                type: Input
            }], dimensions: [{
...
class NgxDocScannerComponent {
    ...
    /** @nocollapse */ static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: NgxDocScannerComponent, deps: [{ token: i1$1.NgxOpenCVService }, { token: LimitsService }, { token: i1.MatBottomSheet }, { token: i4$1.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: NgxDocScannerComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1$1.NgxOpenCVService }, { type: LimitsService }, { type: i1.MatBottomSheet }, { type: i4$1.DomSanitizer }], propDecorators: { previewCanvas: [{
                type: ViewChild,
